...
export default function Example() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-black">
      <Spline className="absolute inset-0 z-0" scene="https://prod.spline.design/69NVrRiOAUfqF4P8/scene.splinecode" />
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        <Dialog className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full bg-black px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
        <h1 className="text-6xl font-serif text-white"></h1>
      </div>
    </div>
  )
}
